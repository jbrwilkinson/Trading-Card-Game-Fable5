...
export const FIXTURE_CARDS: Card[] = [
  ...
  },
  {
    ...
    faction: "fellowship",
    kind: "character",
    rulesText: "When this character attacks: deal 1 extra damage to the opponent's active character.",
    artId: "elf-archer",
    cost: { total: 2 },
    power: 2,
    resilience: 3,
    abilities: [
      { trigger: "onAttack", effect: { type: "damage", amount: 1, target: { scope: "opponentActive" } } },
    ],
    tags: ["elf", "archer"],
  },
  {
    ...
    faction: "fellowship",
    kind: "character",
    rulesText: "At the start of your turn: heal 1 damage from your active character.",
    artId: "herb-master",
    cost: { total: 2 },
    power: 1,
    resilience: 3,
    abilities: [
      { trigger: "onTurnStart", effect: { type: "heal", amount: 1, target: { scope: "ownActive" } } },
    ],
    tags: ["healer"],
  },
  {
